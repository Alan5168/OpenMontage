...
class ComfyUIClient:
    ...
    def __init__(
        ...
        # Windows studio instrumentation: lets callers split queue/exec/download
    ...
    def _history_entry(self, prompt_id: str) -> dict | None:
        ...
        if status.get("status_str") == "error":
            ...
            raise ComfyUIError(f"Execution error: {compact_execution_error(msgs)}", prompt_id=prompt_id)
        return entry
