...
class VideoCompose(BaseTool):
    ...
    def _remotion_render(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            # Job-scoped browser executable (Windows studio fix): computed by
            # _append_remotion_browser_executable() before staging; must ride
            # with the render command even under the staging refactor.
