    ...
    def execute(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        if not custom_workflow:
            if wants_h3:
                ...
                # Partner Node families are hosted APIs: no local model check.
                required = []
                workflow_key = model_family
        ...
        try:
            ...
            provenance = self._workflow_provenance(
                ...
                wants_h3=wants_h3, model_family=model_family,
            )
