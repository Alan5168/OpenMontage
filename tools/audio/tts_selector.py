...
class TTSSelector(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "style_instruction": {
                "type": "string",
                "description": "Provider-level delivery instructions for expressive narration when supported (natural-language delivery direction for providers such as MiMo).",
            },
            "speaking_rate": {
                "type": "number",
                "minimum": 0.25,
