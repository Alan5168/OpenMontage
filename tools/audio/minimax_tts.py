...
class MiniMaxTTS(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "voice_id": {
                "type": "string",
                "description": (
                    "MiniMax system voice_id. "
                    "Default = MINIMAX_TTS_VOICE env var / `male-qn-jingying` (system voice). "
                    "DO NOT use AlanBilibiliNarrator01/02 (clones — quality unusable, removed 2026-07-24)."
                ),
            },
            "model": {
                "type": "string",
    ...
    # ─────────────────────────────────────────────────────────────────────
    # HARD RULE 2026-07-24 — DO NOT use AlanBilibiliNarrator02 (cloned
    # voice, quality is unusable per CEO). The previous default was the
    # Alan Bilibili channel clone (Logic-recorded, second version).
    # Current default is the MiniMax system voice `male-qn-jingying`
    # (clear young male, suitable for CN Bilibili narration).
    # Override per-call via voice_id=... or via MINIMAX_TTS_VOICE env var.
    # NEVER set AlanBilibiliNarrator02 or AlanBilibiliNarrator01 here.
    # ─────────────────────────────────────────────────────────────────────
    DEFAULT_VOICE = "male-qn-jingying"  # was: AlanBilibiliNarrator02 (CLONE — REJECTED)
